---
title: "Daily IELTS Reading — Designing Space Habitats for Mental Health"
...
**MIT AeroAstro:** https://aeroastro.mit.edu/news-impact/interactive-causal-diagram-of-habitat-design-impacts-on-behavioral-health-and-performance-in-extreme-environments/

## Introduction

Long-duration missions to the Moon and Mars require habitats that support not only physical survival but also behavioral health and crew performance. MIT researchers use a Directed Acyclic Graph (DAG) to map how habitat-design choices can influence human outcomes in isolated, confined, and extreme environments.

## Vocabulary

1. **habitat** — an environment designed for people or organisms to live in.
2. **thrive** — develop and function well, rather than merely survive.
3. **wellbeing** — overall physical and mental health.
4. **isolation** — separation from other people or normal surroundings.
5. **cohesion** — the ability of a group to remain connected and cooperative.
6. **reconfigurable** — able to be rearranged for different uses.
7. **intervention** — an action intended to improve a situation.
8. **mitigate** — reduce the severity of a negative effect.
9. **circadian rhythm** — the body's roughly 24-hour sleep-wake cycle.
10. **downstream effect** — a later consequence caused by an earlier factor.
11. **constraint** — a limitation that restricts available choices.
12. **human-centered** — designed around human needs and behavior.
13. **causal relationship** — a relationship in which one factor contributes to producing another.
14. **austere** — difficult, restricted, or lacking normal comforts.
